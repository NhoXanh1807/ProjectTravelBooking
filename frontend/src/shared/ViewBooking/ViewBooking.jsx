  ...
  return (
    <div className="container">
      <main className="main-content">
        ...
        <div className="tabs">
          <button className="tab active">Payment</button>
        </div>
        <section className="booking-details">
          <div className="info">
            <p><strong>Booking ID:</strong> B1001</p>
            <p><strong>Payment ID:</strong> P1001</p>
            <p><strong>Payment Date:</strong> 13/02/2024</p>
          ...
          <div className="total-payment">
            <p>TOTAL PAYMENT: <span>6.900.000 VND</span></p>
          </div>
        </section>
