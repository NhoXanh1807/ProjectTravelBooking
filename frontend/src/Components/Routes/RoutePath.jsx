...
import Tourspage from "./../Pages/Tourspage/Tourspage"; // Adjust the path if Tourpage.jsx is in a different folder
const RoutePath = () => {
    return (
        <Router>
          <div>
            <Routes>
              ...
              <Route path="/tours" element={<Tourspage />} /> {/* Redirect to Login if the route is not found */}
            </Routes>
          </div>
        </Router>
      );
